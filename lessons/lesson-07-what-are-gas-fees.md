...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_07/first-crypto-steps_07_summary.png)
...
### Header Image
**Concept:** Postage stamp evolving into digital gas meter/fuel pump for blockchain
**Style:** Traditional to digital transition
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Gas Fees by Network"
**Content:** Bar chart showing typical fee ranges: Ethereum (tall bar), L2s (small bar), Solana (tiny bar). Show ranges.
**Style:** Comparison chart, easy to scan

### Analogy Illustration
**Concept:** Postage stamps of different sizes = different gas fees
**Style:** Postal/mailing theme

### Audio Notes
- Postage analogy is intuitive—use throughout
- Give specific fee ranges for major networks
- Explain why keeping native tokens is important
- Duration target: 4 minutes

### Video Concept
- Animation of transaction needing "fuel" to travel
- Show fee variations in real-time gas tracker style
- Demonstrate slow vs. fast fee selection
