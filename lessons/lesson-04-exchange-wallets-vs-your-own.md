...
**Core concept:** Leaving crypto on an exchange is like using a coat check—convenient but you're trusting someone else with your property.
...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_04/first-crypto-steps_04_summary.png)
...
### Header Image
**Concept:** Split scene: coat check desk with ticket vs. person's own closet at home
**Style:** Contrast between trusting others vs. self-management
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Exchange vs. Self-Custody"
**Content:** Two columns: Exchange (convenient, they hold keys, counterparty risk) vs. Own Wallet (more effort, you hold keys, you are responsible). Decision flow below.
**Style:** Comparison with decision tree

### Analogy Illustration
**Concept:** Coat check scenario—show convenience and risk in one image
**Style:** Restaurant/hotel setting

### Audio Notes
- Coat check analogy should land clearly
- Tell the Mt. Gox/FTX stories briefly
- Present as choice, not judgment
- Duration target: 4-5 minutes

### Video Concept
- Animation showing "where is your crypto really?"
- Historical failures timeline
