...
**Core concept:** A cryptocurrency exchange is like a currency exchange at the airport—a place to swap one type of money for another.
...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_01/first-crypto-steps_01_summary.png)
...
### Header Image
**Concept:** Airport currency exchange booth that transforms into digital screen showing crypto prices
**Style:** Transition from physical to digital
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "CEX vs DEX"
**Content:** Two-column comparison: Centralized (company, accounts, identity required) vs. Decentralized (smart contracts, wallets, permissionless)
**Style:** Side-by-side comparison with icons

### Analogy Illustration
**Concept:** Currency exchange booth with crypto logos alongside traditional currency symbols
**Style:** Familiar yet futuristic

### Audio Notes
- Start with airport analogy—very relatable
- Explain CEX vs DEX clearly, recommend CEX for beginners
- Emphasize exchange ≠ wallet
- Duration target: 4-5 minutes

### Video Concept
- Animation of exchange process: dollars in, crypto out
- Show difference between CEX (company in middle) and DEX (direct)
- Interface walkthrough concept
