...
**Core concept:** Buying crypto is like buying foreign currency for a trip—you're exchanging money you have for money you want, with some fees along the way.
...
**Bank transfer (ACH):** Lower fees, takes 1-5 days to process
**Debit card:** Instant, moderate fees (1-2%)
**Credit card:** Instant, highest fees (2-4%), may be treated as cash advance
...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_03/first-crypto-steps_03_summary.png)
...
### Header Image
**Concept:** Journey from bank card to crypto in wallet—visual flow of the purchase process
**Style:** Progressive transformation
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "First Purchase Checklist"
**Content:** 7 steps as checklist: Add payment → Navigate to buy → Select crypto → Enter amount → Review fees → Confirm → View balance
**Style:** Checklist with green checkmarks

### Analogy Illustration
**Concept:** Currency exchange counter with crypto twist—handing dollars, receiving crypto coins
**Style:** Friendly, approachable

### Audio Notes
- Walk through steps methodically
- Emphasize "only invest what you can afford to lose"
- Make it feel achievable and safe
- Duration target: 4-5 minutes

### Video Concept
- Screen recording style walkthrough (generalized, not specific exchange)
- Show each step with narration
- Highlight fee review moment
- Duration: 3 minutes
