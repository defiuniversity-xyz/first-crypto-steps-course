...
### Header Image
**Concept:** Multiple parallel highways/delivery routes labeled with different blockchain names, packages needing to match routes
**Style:** Logistics/delivery metaphor
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Network Matching"
**Content:** Show token (e.g., USDC) with multiple network "delivery routes." Checkmark for matching, X for mismatched. Show consequences.
**Style:** Flow diagram with success/failure paths

### Analogy Illustration
**Concept:** FedEx vs. UPS packages, showing what happens when mismatched
**Style:** Shipping/logistics scenario

### Audio Notes
- Delivery service analogy makes this tangible
- Give specific examples of common tokens on multiple networks
- Emphasize "verify before sending" emphatically
- Duration target: 4 minutes

### Video Concept
- Animation of transaction choosing network
- Show parallel blockchains as separate highways
- Demonstrate successful match vs. mismatch consequences
