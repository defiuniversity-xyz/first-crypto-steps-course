...
**What they are:**
Devices or methods that keep private keys offline, never exposed to internet.
...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_09/first-crypto-steps_09_summary.png)
...
### Header Image
**Concept:** Split scene: phone with wallet app (hot) vs. hardware wallet device in safe (cold)
**Style:** Convenience vs. security contrast
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Hot vs. Cold Storage"
**Content:** Two columns comparing: connectivity, convenience, security, best uses. Visual thermometer showing "hot" and "cold"
**Style:** Temperature/gauge visual metaphor

### Analogy Illustration
**Concept:** Checking account (easy ATM access) vs. safe deposit box (secure, less frequent access)
**Style:** Bank/financial setting comparison

### Audio Notes
- Make checking/savings analogy clear
- Explain hardware wallet workflow simply
- Suggest the layered approach for practical use
- Duration target: 4-5 minutes

### Video Concept
- Animation showing hot wallet constantly online
- Contrast with hardware wallet air-gapped process
- Show the signing flow for hardware wallet
- Duration: 3 minutes
