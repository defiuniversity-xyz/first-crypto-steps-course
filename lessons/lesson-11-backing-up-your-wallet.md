...
Copy exactly, in exact order. One wrong word or wrong order = won't work.
...
No photos. No screenshots. No email. No cloud. No notes app. No password manager. Hackers look for these.
...
Keep copies in different physical locations. House fire shouldn't destroy all backups.

**Different mediums:**
Paper backup + metal backup. If one fails (fire destroys paper, water damages metal), other survives.

**Consider splitting:**
Some people split seed phrase: words 1-6 in location A, words 7-12 in location B. Controversial—requires finding both, but also protects against single theft.

**Test your backups:**
Before significant funds, verify you can restore from backup. Try on a separate device.
...
![Summary](https://storage.googleapis.com/first-crypto-steps-media/images/lesson_11/first-crypto-steps_11_summary.png)
...
### Header Image
**Concept:** Multiple house keys being made, stored in different secure locations (safe, bank, trusted person)
**Style:** Security redundancy visual
**Dimensions:** 1200x630px

### Concept Infographic
**Title:** "Backup Storage Options"
**Content:** Grid showing: Paper (fire risk), Metal (flood/fire resistant), Safe (theft protection), Multiple locations (full protection). Rate each option.
**Style:** Comparison grid with ratings

### Analogy Illustration
**Concept:** Spare house keys distributed to different secure spots
**Style:** Home security scenario

### Audio Notes
- House key analogy is relatable
- Emphasize NEVER digital storage emphatically
- Address inheritance planning seriously
- Duration target: 4-5 minutes

### Video Concept
- Show different backup materials (paper, metal plates)
- Demonstrate what NOT to do (screenshot, type into phone)
- Show restore process working from backup
- Duration: 3 minutes
